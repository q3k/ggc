...
# [GCC 8.2.0]
# Embedded file name: google3/third_party/py/defusedxml/ElementTree.py
...
def _get_py3_cls():
    ...
    return (
     _XMLParser, _iterparse, ParseError)
...
class DefusedXMLParser(_XMLParser):
    ...
    def __init__(self, html=0, target=None, encoding=None, forbid_dtd=False, forbid_entities=True, forbid_external=True):
...
__all__ = [
 ...
 'parse', 'tostring']
# okay decompiling ./google3/third_party/py/defusedxml/ElementTree.pyc
